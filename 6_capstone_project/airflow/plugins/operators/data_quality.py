...
class DataQualityOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        null_table_checks = ['immigrant', 'immigrant_stats', 'city_population', 'city_demographics', 'arrival_info', 'arrival_date']
        null_column_checks = ['immigrant_id', 'immigrant_id', 'city', 'city', 'immigrant_id', 'arrival_date']
